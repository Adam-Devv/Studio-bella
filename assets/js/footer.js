        ...
        <div class="inner">
            <div class="row">
                <div class="6u 12u$(xsmall)">
                    ...
                    <ul class="icons">
                        <li><a href="https://www.facebook.com/studiobellaspa/" class="icon fa fa-facebook" style ="padding-right:10px;" target="_blank"></a></li>
                        <li><a href="https://www.instagram.com/studio.bella.spa.atx/?hl=en" class="icon fa fa-instagram" target="_blank"></a></li>
                    </ul>
                </div>
                <div class="6u$ 12u$(xsmall)">
                    <h4>Contact</h4>
                    ...
                    <div id="mc_embed_signup" style="margin-top: 2em;">
                        <form action="https://studio-bella.us20.list-manage.com/subscribe/post?u=eb9102a6f041c56e986db8d4b&id=b116ecd2de" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                            <div id="mc_embed_signup_scroll">
                                <label for="mce-EMAIL" style="color:white;">Subscribe to our Newsletter for Updates and Specials!</label>
